...
#line 41 "transform.y"
                          { printf("%s\n", yyvsp[-1]); }
#line 1099 "transform.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 47 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"+");  }
#line 1105 "transform.tab.c"
    break;

  case 6: /* expr: expr SUB expr  */
#line 48 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"- "); }
#line 1111 "transform.tab.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 49 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"* "); }
#line 1117 "transform.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 50 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[-2]); strcat(yyval,yyvsp[0]); strcat(yyval,"/ "); }
#line 1123 "transform.tab.c"
    break;

  case 9: /* expr: LEFT_PAR expr RIGHT_PAR  */
#line 51 "transform.y"
                                     { yyval = yyvsp[-1]; }
#line 1129 "transform.tab.c"
    break;

  case 10: /* expr: SUB expr  */
#line 52 "transform.y"
                                   { yyval = (char*)malloc(60); strcpy(yyval,"- "); strcat(yyval,yyvsp[0]); }
#line 1135 "transform.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 53 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[0]); strcat(yyval," "); }
#line 1141 "transform.tab.c"
    break;

  case 12: /* expr: ID  */
#line 54 "transform.y"
                          { yyval = (char*)malloc(60); strcpy(yyval,yyvsp[0]); strcat(yyval," "); }
#line 1147 "transform.tab.c"
    break;


#line 1151 "transform.tab.c"
